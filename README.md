## Awesome OpenSource CMS platforms
...
* [Swastika I/O Core CMS](https://github.com/Swastika-IO/Swastika-IO-Core) - Open source ASP.NET Core 2.x CMS. It currently supports MS SQL and planned to implement MySQL, SQLite in the near future. It has many built-in features out of the box like multilanguage support, theme, template...
...
## Awesome Node.JS OpenSource CMS platforms

(WIB)

## Awesome PHP OpenSource CMS platforms

(WIB)

## Awesome Java OpenSource CMS platforms

(WIB)

## Awesome Python OpenSource CMS platforms

(WIB)

## Awesome Go OpenSource CMS platforms
...
To the extent possible under law, [Huy Nguyen](https://github.com/Smilefounder) has waived all copyright and related or neighboring rights to this work.
